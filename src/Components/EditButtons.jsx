...
const EditButtons = ({id,notes,setNotesData,pTagRef,noteRef }) => {
  ...
  return (
    <div className='absoulate top-3 right-3 p-1'>
        <div className='w-6 h-6 flex justify-center items-center rounded-full cursor-pointer hover:bg-[#E9ECEF] dark:hover:bg-[#272727] ' onClick={handleEditButtonsDisplay}>
...
const EditButtonsDiv = ({id,notes,setNotesData,isButtonsOn,handleEditButtonsDisplay,handleSaveBtnDisplay})=>{
    ...
    return (
        <div className='bg-[#e8eaed] dark:bg-[#272727] w-20 px-1 py-2 rounded-md z-10 absolute top-0 right-0'>
            ...
            <ul className='list-none mt-4'>
                <li className='cursor-pointer hover:bg-[#DEE2E6] dark:hover:bg-[#2f2f2f] w-full px-2 rounded-md mb-1 ' onClick={handleEditBtn}>Edit</li>
                <li onClick={handleDeletation} className='cursor-pointer hover:bg-[#DEE2E6] dark:hover:bg-[#2f2f2f] w-full px-2 rounded-md '>Delete</li>
            </ul>
        </div>
    )
}
...
const SaveEditedNoteBtn = ({displaySaveBtn,handleSaveBtnDisplay,handleSaveContent})=>{
    ...
    return (
        <div className='bg-[#e8eaed] dark:bg-[#272727] w-14 px-1 py-1 rounded-md z-10 absolute top-0 right-0'>
