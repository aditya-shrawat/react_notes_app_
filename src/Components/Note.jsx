...
const Note = ({id,title,content,date,notes,setNotesData}) => {
  ...
  return (
    <div className='bg-[#F8F9FA] max-w-lg h-64 max-h-64 rounded-xl p-3 overflow-hidden flex flex-col justify-between relative hover:shadow-lg ' ref={noteRef} >
        ...
        <div className='w-full h-6 bg-[#F8F9FA]'>
